...
| **Predict Watchdog** (`predict-watchdog.yml`) | Hourly (cron) or manual | Checks `predictions.log`; if the latest run is older than 3 hours and no Predict run is active, dispatches `predict.yml` |
