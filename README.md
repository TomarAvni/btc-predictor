...
| **Predict Watchdog** (`predict-watchdog.yml`) | Hourly cron or manual | Checks committed prediction freshness and runs Predict only when output is older than 3 hours |
