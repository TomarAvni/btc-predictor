...
| **Predict Watchdog** (`predict-watchdog.yml`) | Hourly cron or manual | Checks `predictions.log`; if the latest entry is over 3 hours old and no Predict run is active, dispatches Predict |
